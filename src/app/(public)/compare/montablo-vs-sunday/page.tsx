...
export const metadata: Metadata = {
  ...
  description:
    'Comparatif détaillé entre MonTablo et Sunday pour votre menu digital de restaurant. Prix, fonctionnalités, simplicite : découvrez quelle solution choisir.',
  openGraph: {
    title: 'MonTablo vs Sunday : comparatif menu digital restaurant — MonTablo',
    description:
      'MonTablo vs Sunday : quel menu digital choisir pour votre restaurant ? Comparatif prix, fonctionnalités et simplicite.',
  },
}
...
const comparisonRows = [
  ...
  },
  {
    ...
    montablo: 'Prêt en 5 minutes, zéro materiel',
    advantage: 'montablo' as const,
  },
  {
    icon: Utensils,
    ...
    montablo: 'Conçu 100 % autour du menu digital',
    advantage: 'montablo' as const,
  },
  {
    icon: RefreshCw,
    criteria: 'Menu du jour',
    competitor: 'Fonctionnalité limitee',
...
const faqs = [
  {
    question: 'Quelle est la différence principale entre MonTablo et Sunday ?',
    answer:
      'Sunday est avant tout une solution de paiement a table par QR code, qui propose également un menu digital. MonTablo est entierement dédié au menu digital : design, mises à jour instantanées, menu du jour, promotions et import IA. Si votre priorite est le menu, MonTablo est plus adapte. Si vous cherchez principalement le paiement a table, Sunday peut être plus pertinent.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Non. MonTablo se concentre exclusivement sur le menu digital pour offrir la meilleure expérience possible : design soigné, import IA, menu du jour, promotions, bilingue. Le paiement a table n\'est pas dans notre perimetre.',
  },
  {
    question: 'Est-ce que Sunday convient aux petits restaurants ?',
    answer:
      'Sunday cible principalement les restaurants de taille moyenne a grande, avec un volume de transactions suffisant pour rentabiliser le systeme de paiement. MonTablo s\'adresse a tous les restaurants, y compris les petits établissements, avec un prix fixe et accessible.',
  },
]
      ...
      <section className="bg-white border-y border-border/50">
        <div className="max-w-[780px] mx-auto px-6 py-20">
          <h2 className="font-serif text-3xl text-foreground text-center mb-16">
            Deux approches différentes pour le QR code en restaurant
          </h2>
          ...
          <div className="mb-14">
            ...
            <p className="text-[15px] text-muted leading-relaxed mb-4">
              Sunday s&apos;est fait connaître grace a son systeme de paiement a table par
              QR code. Le client scanne, consulte l&apos;addition et paye directement depuis
              son téléphone. Le menu digital est propose en complement, mais ce n&apos;est pas
              le cœur de leur produit.
            </p>
            <p className="text-[15px] text-muted leading-relaxed">
              Si votre objectif principal est d&apos;accélérer le paiement et de réduire
              ...
              <Link href="/menu-digital-restaurant" className="text-primary hover:underline">
                menu digital soigné et facile a gérer
              </Link>
          ...
          <div className="mb-14">
            ...
            <p className="text-[15px] text-muted leading-relaxed mb-4">
              ...
              ce qui peut representer un coût significatif pour les restaurants a fort volume.
          ...
          <div className="mb-14">
            <h3 className="font-serif text-2xl text-foreground mb-4">
              Des fonctionnalités menu plus poussees
            </h3>
            <p className="text-[15px] text-muted leading-relaxed mb-4">
              MonTablo a été conçu exclusivement pour le menu digital. Cela se traduit par
              des fonctionnalités dédiées : menu du jour ajustable en 30 secondes, promotions
              temporaires programmables, import de votre carte par IA, QR code personnalisé
          ...
          <div>
            ...
            <p className="text-[15px] text-muted leading-relaxed mb-4">
              Si le paiement a table est votre priorite absolue et que vous gérez un
              restaurant de taille moyenne a grande avec un fort volume de couverts,
              Sunday peut être un choix pertinent. Leur ecosysteme de paiement est
              mature et bien intégré.
            </p>
            <p className="text-[15px] text-muted leading-relaxed">
              En revanche, si vous cherchez un menu digital élégant, simple a gérer
      ...
      <section className="max-w-[1120px] mx-auto px-6 pb-20">
        <div className="border border-border rounded-[20px] py-16 px-8 text-center bg-gradient-to-b from-white to-background">
          <h2 className="font-serif text-3xl text-foreground mb-3">
            Prêt a créer votre menu digital ?
          </h2>
