...
export const metadata: Metadata = {
  title: 'Restaurants de station — MonTablo : menu digital QR multilingue avec fidélité Wallet',
  description:
    'Le menu digital pour les restaurants de station de Haute-Savoie. Annecy, Chamonix, Évian, Saint-Julien : multilingue FR/EN/DE, fidélité Wallet, mises à jour temps réel.',
  alternates: { canonical: '/solutions/haute-savoie' },
  openGraph: {
    title: 'Restaurants de station — MonTablo',
    description: 'Le menu digital pour les restaurants de station de Haute-Savoie.',
...
const pains = [
  "Hiver = clientèle suisse + UK. Été = familles françaises + italiennes.",
  "Carte saisonnière qui change tous les 3 mois.",
  "Cartes papier en 4 langues à imprimer à chaque saison.",
  "Clients qui reviennent chaque saison mais qu'on n'arrive pas à fidéliser.",
]
...
const features = [
  {
    ...
    desc: "Vos clients suisses, allemands, britanniques basculent dans leur langue d'un tap. Traduction automatique, vérifiable plat par plat. La carte vit en 3 langues sans double saisie.",
    benefit: "Plus de cartes papier à réimprimer en 4 langues à chaque saison.",
  },
  {
    icon: Wallet,
    title: 'Cartes de fidélité Wallet',
    desc: "Vos clients ajoutent leur carte à Apple Wallet ou Google Wallet en un scan. La carte réapparaît automatiquement sur leur écran d'accueil quand ils repassent à la station — même un an plus tard.",
    benefit: "La clientèle saisonnière devient une clientèle fidèle.",
  },
  {
    icon: Zap,
    title: 'Mises à jour temps réel',
    desc: "Vous passez de la carte d'hiver à la carte d'été depuis votre téléphone. Plat épuisé ? Désactivé en un tap. Vos clients ne voient jamais un plat qui n'existe plus.",
    benefit: "Une carte saisonnière sans réimpression, sans tippex.",
  },
]

const faqItems = [
  {
    question: 'MonTablo fonctionne-t-il dans toutes les stations de Haute-Savoie ?',
    answer:
      'Oui. MonTablo est utilisé dans toute la Haute-Savoie — d\'Annecy à Chamonix, d\'Évian à Saint-Julien-en-Genevois. La solution est conçue pour les restaurants de station : multilingue FR/EN/DE, mises à jour saisonnières, fidélité Wallet pour la clientèle qui revient chaque année.',
  },
  {
    question: 'Comment gérer une carte saisonnière qui change tous les 3 mois ?',
    answer:
      'Vous préparez votre carte d\'été en avance, vous la publiez le jour J en un clic. Vous pouvez aussi désactiver des sections entières (fondues, raclettes) hors saison sans les supprimer — elles réapparaissent à l\'hiver suivant.',
  },
  {
    question: 'Combien coûte MonTablo pour un restaurant en Haute-Savoie ?',
    answer:
      'Essai gratuit 14 jours sans carte bancaire. Ensuite : Essentiel 19€/mois HT pour digitaliser la carte, Pro 39€/mois HT pour la formule complète (avis Google, fidélité Wallet, multilingue), ou Premium sur devis pour les groupes multi-établissements.',
  },
]
    ...
    <div className="bg-background min-h-screen text-foreground font-sans text-[17px] leading-[1.55] antialiased overflow-x-hidden">
      ...
      <JsonLd
        data={localBusinessJsonLd({
          ...
          description:
            'MonTablo est une solution de menu digital pour les restaurants de station de Haute-Savoie. Multilingue FR/EN/DE, fidélité Apple/Google Wallet, mises à jour temps réel.',
        })}
      />
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-[14px] bg-background/80 border-b border-primary/5">
        <div className="max-w-[1240px] mx-auto px-8 flex items-center justify-between h-[76px]">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <CTALink href="/signup" label="hsavoie_nav_essai" className={BTN_PRIMARY_SM}>Essai gratuit</CTALink>
          </div>
        </div>
      </nav>
      ...
      <section className="relative overflow-hidden pt-[70px] pb-20">
        ...
        <div className="relative z-10 max-w-[1240px] mx-auto px-8 grid md:grid-cols-[1.1fr_0.9fr] gap-[60px] md:gap-20 items-center">
          <div className="min-w-0">
            <span className={EYEBROW}>Pour les restaurants de station — Haute-Savoie</span>
            <h1 className="font-serif font-medium text-primary text-[clamp(36px,5vw,64px)] leading-[1.05] tracking-[-0.022em] text-balance">
              Le menu digital pour les restaurants de{' '}
              <em className="italic font-medium text-primary-light">station</em> de Haute-Savoie.
            </h1>
            <p className="text-[19px] text-muted max-w-[580px] my-6 mb-8 leading-[1.5]">
              Annecy, Chamonix, Évian, Saint-Julien : votre clientèle change de pays toutes les 2 semaines. Votre menu doit suivre.
            </p>
            <div className="flex flex-wrap gap-3">
              <CTALink href="/signup" label="hsavoie_hero_essai" className={BTN_PRIMARY}>
            ...
            <div className="relative w-[300px] h-[560px] bg-white rounded-[42px] shadow-[0_30px_60px_rgba(30,57,50,0.18),0_10px_20px_rgba(30,57,50,0.08)] border-[10px] border-primary overflow-hidden -rotate-[3deg]" aria-hidden="true">
              ...
              <div className="h-full bg-background pt-[44px] px-5 pb-5">
                <div className="flex items-center justify-between pb-4 border-b border-border">
                  <h4 className="font-serif text-[18px] italic text-primary font-medium">Le Refuge</h4>
                ...
                <div className="space-y-2.5">
                  <div className="bg-white rounded-xl px-3 py-2.5 border border-border">
                    <div className="font-semibold text-primary text-[13px]">Fondue savoyarde</div>
                    <div className="text-[11px] text-muted italic">Beaufort, comté, abondance</div>
                    <div className="font-bold text-primary-light text-[13px] mt-1.5">24,00 €</div>
                  </div>
                  <div className="bg-white rounded-xl px-3 py-2.5 border border-border">
                    <div className="font-semibold text-primary text-[13px]">Tartiflette</div>
                    <div className="text-[11px] text-muted italic">Reblochon fermier, lardons</div>
                    <div className="font-bold text-primary-light text-[13px] mt-1.5">19,00 €</div>
                  </div>
                  <div className="bg-green-mist rounded-xl px-3 py-2.5 border border-primary-light/30 flex items-center gap-2">
                    <Wallet className="w-4 h-4 text-primary" strokeWidth={1.8} />
                    <div>
                      <div className="text-[10px] tracking-[0.15em] uppercase text-primary-light font-bold">Fidélité Wallet</div>
                      <div className="text-[11px] text-muted">Ajoutez votre carte en un scan</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-[1040px] mx-auto px-8 py-20 sm:py-[100px]">
          <div className="max-w-[680px] mb-12">
            ...
            <h2 className="font-serif text-[clamp(30px,4vw,44px)] leading-[1.1] tracking-tight text-primary text-balance">
              Ce qu&apos;on entend tous les jours dans les <em className="italic">stations</em>.
            </h2>
          </div>
      ...
      <section className="bg-surface border-y border-border py-20 sm:py-[100px]">
        <div className="max-w-[1240px] mx-auto px-8">
          <div className="max-w-[680px] mb-12">
            <span className={EYEBROW}>Votre ville</span>
            <h2 className="font-serif text-[clamp(30px,4vw,44px)] leading-[1.1] tracking-tight text-primary text-balance">
              MonTablo, dans toute la <em className="italic">Haute-Savoie</em>.
            </h2>
            <p className="text-[17px] text-muted mt-4 leading-relaxed">
              Conseils et cas d&apos;usage par ville — cliquez sur la vôtre.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
            {VILLES.map((ville) => (
              <Link
                ...
                className="group flex items-center justify-between bg-white border border-border rounded-2xl px-5 py-4 hover:-translate-y-0.5 hover:shadow-[0_10px_30px_rgba(30,57,50,0.08)] transition"
              >
                <span className="font-serif text-[17px] text-primary group-hover:text-primary-light transition-colors">
                  {ville.name}
                </span>
                <ArrowRight className="w-4 h-4 text-muted group-hover:text-primary-light group-hover:translate-x-0.5 transition-all" />
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 sm:py-[100px]">
        <div className="max-w-[860px] mx-auto px-8">
          <div className="text-center mb-12">
            <span className={EYEBROW}>FAQ Haute-Savoie</span>
            <h2 className="font-serif text-[clamp(30px,4vw,44px)] leading-[1.1] tracking-tight text-primary text-balance">
      ...
      <section className="py-24 sm:py-32 bg-surface border-t border-border">
        <div className="max-w-[820px] mx-auto px-8 text-center">
          <div className="w-14 h-14 rounded-2xl bg-green-soft flex items-center justify-center mx-auto mb-6">
            <Mountain className="w-7 h-7 text-primary" strokeWidth={1.6} />
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mt-9">
            <CTALink href="/signup" label="hsavoie_final_essai" className={BTN_PRIMARY}>Démarrer mon essai gratuit</CTALink>
