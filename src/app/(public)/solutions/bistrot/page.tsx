...
const features = [
  ...
  {
    icon: Tag,
    title: 'Promotions et suggestions',
    description: 'Mettez en avant votre formule du midi ou votre plat du jour avec des promotions visibles directement sur le menu.',
  },
  {
...
const steps = [
  ...
  },
  {
    ...
    description: 'Choisissez les couleurs de votre bistrot et publiez votre menu en un clic.',
  },
  {
    number: '3',
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-[1120px] mx-auto px-6 pt-[100px]">
        <nav className="text-[13px] text-muted/60">
          ...
          <span className="mx-2">/</span>
          <span className="text-foreground">Bistrot</span>
        </nav>
      </div>
      ...
      <section className="max-w-[1120px] mx-auto px-6 pb-24">
        <h2 className="font-serif text-3xl text-foreground mb-10">
          Pourquoi MonTablo pour votre bistrot
        </h2>
